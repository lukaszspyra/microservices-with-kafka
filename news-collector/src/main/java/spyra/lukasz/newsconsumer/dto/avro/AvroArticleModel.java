 ...
 */
package spyra.lukasz.newsconsumer.dto.avro;
...
public class AvroArticleModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3904689317823331758L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroArticleModel\",\"namespace\":\"spyra.lukasz.newsconsumer.dto.avro\",\"fields\":[{\"name\":\"author\",\"type\":\"string\"},{\"name\":\"title\",\"type\":\"string\"},{\"name\":\"news\",\"type\":{\"type\":\"record\",\"name\":\"AvroNewsModel\",\"fields\":[{\"name\":\"content\",\"type\":\"string\"}]}}]}");
  ...
  public static AvroArticleModel fromByteBuffer(
   ...
   private spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel news;
   ...
   */
  public AvroArticleModel(java.lang.CharSequence author, java.lang.CharSequence title, spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel news) {
    this.author = author;
    this.title = title;
    this.news = news;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: news = (spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel getNews() {
    return news;
  }
   ...
   * @param value the value to set.
   */
  public void setNews(spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel value) {
    this.news = value;
  }
   ...
   */
  public static spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder newBuilder() {
    return new spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder();
  }
   ...
   * @return A new AvroArticleModel RecordBuilder
   */
  public static spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder newBuilder(spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder other) {
    if (other == null) {
      return new spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder();
    } else {
      return new spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder(other);
    }
  }
   ...
   * @return A new AvroArticleModel RecordBuilder
   */
  public static spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder newBuilder(spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel other) {
    if (other == null) {
      return new spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder();
    } else {
      return new spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroArticleModel>
    ...
    private java.lang.CharSequence title;
    private spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel news;
    private spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder newsBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder other) {
      super(other);
      ...
      if (other.hasNewsBuilder()) {
        this.newsBuilder = spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.newBuilder(other.getNewsBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.author)) {
        this.author = data().deepCopy(fields()[0].schema(), other.author);
    ...
    /**
      ...
      * @return This builder.
      */
    public spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder setAuthor(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder clearAuthor() {
      author = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder setTitle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder setNews(spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel value) {
     ...
     * @return This builder.
     */
    public spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder getNewsBuilder() {
      if (newsBuilder == null) {
        if (hasNews()) {
          setNewsBuilder(spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.newBuilder(news));
        } else {
          setNewsBuilder(spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.newBuilder());
        }
      }
      return newsBuilder;
    }
    ...
    public spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder setNewsBuilder(spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder value) {
      clearNews();
      newsBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public spyra.lukasz.newsconsumer.dto.avro.AvroArticleModel.Builder clearNews() {
      news = null;
      newsBuilder = null;
    ...
    public AvroArticleModel build() {
      try {
        ...
        if (newsBuilder != null) {
          ...
          record.news = fieldSetFlags()[2] ? this.news : (spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel) defaultValue(fields()[2]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.news == null) {
        this.news = new spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel();
      }
