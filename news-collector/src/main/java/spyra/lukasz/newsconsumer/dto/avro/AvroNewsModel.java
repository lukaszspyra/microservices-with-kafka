...
public class AvroNewsModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2833690879803379579L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroNewsModel\",\"namespace\":\"spyra.lukasz.newsconsumer.dto.avro\",\"fields\":[{\"name\":\"content\",\"type\":\"string\"}]}");
   ...
   */
  public static spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder newBuilder() {
    return new spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder();
  }
   ...
   * @return A new AvroNewsModel RecordBuilder
   */
  public static spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder newBuilder(spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder other) {
    if (other == null) {
      return new spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder();
    } else {
      return new spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder(other);
    }
  }
   ...
   * @return A new AvroNewsModel RecordBuilder
   */
  public static spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder newBuilder(spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel other) {
    if (other == null) {
      return new spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder();
    } else {
      return new spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroNewsModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.content)) {
        this.content = data().deepCopy(fields()[0].schema(), other.content);
    ...
    /**
      ...
      * @return This builder.
      */
    public spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder setContent(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public spyra.lukasz.newsconsumer.dto.avro.AvroNewsModel.Builder clearContent() {
      content = null;
